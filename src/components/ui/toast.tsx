...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-4 z-[100] flex max-h-screen w-full flex-col-reverse p-2 sm:p-4 sm:bottom-4 sm:right-4 sm:top-auto sm:flex-col sm:max-w-[320px] md:max-w-[360px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-xs sm:text-sm opacity-90 leading-tight", className)}
    {...props}
  />
))
